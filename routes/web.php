...
Route::get('/{category_slug}/services', ServicesByCategoryComponent::class)->name('home.serviced_by_category');
...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified', 'authadmin'])->group(function () {
    Route::get('/admid/dashboard', AdminDashboardComponent::class)->name('admin.dashboard');

                                    ...
                                    <div class="col-md-12">
                                        <div class="post-header">
                                            ...
                                            <div class="post-info-wrap">
                                                <h2 class="post-title"><a href="#" title="Post Format: Standard" rel="bookmark">{{$service->name}}: {{$service->category->name}}</a></h2>
                        ...
                        <div class="col-md-4">
                            ...
                            <aside>
                                ...
                                <div class="col-md-12 col-sm-6 col-xs-12 bg-dark color-white padding-top-mini" style="max-width: 360px">
                                    <a href="{{route('home.service_details',['service_slug'=>$id_services->slug])}}">
                                        <div class="img-hover">
                                            <img src="{{asset('images/services/thumbnails')}}/{{$id_services->thumbnail}}" alt="{{$id_services->name}}" class="img-responsive">
                                        </div>
                                        <div class="info-gallery">
                                            ...
                                            <hr class="separator">
                                            <p>{{$id_services->name}}</p>
                                            <div class="content-btn"><a href="{{route('home.service_details',['service_slug'=>$id_services->slug])}}" class="btn btn-warning">View Details</a></div>
                                            <div class="price"><span>&#36;</span><b>From</b>{{$id_services->price}}</div>
                                        </div>
                                    </a>
                                </div>
                                @endif

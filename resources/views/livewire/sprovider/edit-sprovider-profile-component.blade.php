                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="alert alert-success" role="alert">{{Session::get('message')}}. <a href="{{route('sprovider.profile')}}">Back to profile</a></div>
                                            @endif
                                            <form class="form-horizontal" wire:submit.prevent="updateProfile">
                                                ...
                                                <button class="btn btn-success pull-right" type="submit">Update Profile</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>

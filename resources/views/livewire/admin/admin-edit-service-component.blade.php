                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="updateService">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="discount_type" wire:model="discount_type" class="form-control">
                                                    <option value="">Select Dsicount Type</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="featured" wire:model="featured" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="inclusion" id="inclusion" wire:model="inclusion"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="exclusion" id="exclusion" wire:model="exclusion"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" class="form-control-file" name="thumbnail" wire:model="new_thumbnail" />
                                                @error('new_thumbnail') <p class="text-danger">{{$message}}</p> @enderror
                                                @if($new_thumbnail)
                                                <img src="{{ $new_thumbnail->temporaryUrl() }}" width="60" />
                                                @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" class="form-control-file" name="image" wire:model="new_image" />
                                                @error('new_image') <p class="text-danger">{{$message}}</p> @enderror
                                                @if($new_image)
                                                <img src="{{ $new_image->temporaryUrl() }}" width="60" />
                                                @else

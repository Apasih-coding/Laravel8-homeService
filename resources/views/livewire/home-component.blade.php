        ...
        <div class="tp-banner">
            <ul>
                ...
                <li data-transition="slidevertical" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off" data-title="Slide">
                    <img src="{{ asset('images/slider') }}/{{$sld->image}}" alt="{{$sld->title}}" data-bgposition="center center" data-kenburns="on" data-duration="6000" data-ease="Linear.easeNone" data-bgfit="130" data-bgfitend="100" data-bgpositionend="right center">
                </li>
                @endforeach
            </ul>
    ...
    <section class="content-central">
                    ...
                    <div class="col-md-12">
                        <ul id="sponsors" class="tooltip-hover">
                            ...
                            <li data-toggle="tooltip" title="" data-original-title="{{$category->name}}">
                                <a href="{{route('home.serviced_by_category',['category_slug'=>$category->slug])}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <ul class="services-lines">
                                @foreach($dash_category as $dc)
                                <li>
                                    <a href="{{route('home.serviced_by_category',['category_slug'=>$dc->slug])}}">
                                        <div class="item-service-line">
                                            <i class="fa"><img class="icon-img" src="{{ asset('images/categories') }}/{{$dc->image}}"></i>
                                            <h5>{{$dc->name}}</h5>
                                        </div>
                                    </a>
                                </li>
        ...
        <div>
            ...
            <div id="boxes-carousel">
                @foreach($services_home as $sh)
                <div>
                    <a class="g-list" href="{{route('home.service_details',['service_slug'=>$sh->slug])}}">
                        <div class="img-hover">
                            <img src="{{ asset('images/services/thumbnails') }}/{{$sh->thumbnail}}" alt="{{$sh->name}}" class="img-responsive">
                        </div>
                        ...
                        <div class="info-gallery">
                            ...
                            <hr class="separator">
                            <p>{{$sh->tagline}}</p>
                            <div class="content-btn"><a href="{{route('home.service_details',['service_slug'=>$sh->slug])}}" class="btn btn-primary">Book Now</a></div>
                            <div class="price"><span>&#36;</span><b>From</b>${{$sh->price}}</div>
                        </div>
                    </a>
                </div>
                @endforeach

...
<head>
    <meta charset="utf-8">
    <title>gmail - Online Service Provider for your House Needs</title>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+6288450678"><i class="fa fa-phone"></i> +62-88450678</a></li>
                            <li><a href="mailto:contact@gmail.com"><i class="fa fa-envelope"></i>
                                    contact@gmail.com</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="tel:+6288450678"><i class="fa fa-phone"></i>
                                    +62-88450678</a></li>
                            <li class="text-right"><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i> Jakarta Timur, DKI Jakarta</a></li>
                        </ul>
                    </div>
                ...
                <div class="row visible-md visible-lg">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-6">
                        ...
                        <ul class="contact_footer">
                            <li class="location">
                                <i class="fa fa-map-marker"></i> <a href="#"> Jakarta Timur, DKI Jakarta, Indonesia</a>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i> <a href="mailto:contact@gmail.com">contact@gmail.com</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+6288450678">+62-88450678</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+6288450678">+62-88450678</a>
                            </li>
                        </ul>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2021 gmail. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
